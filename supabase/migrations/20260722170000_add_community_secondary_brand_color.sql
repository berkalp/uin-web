...
-- ============================================================
-- COMMUNITY PRIMARY + SECONDARY BRAND COLORS
-- ============================================================
...
alter table public.communities
  drop constraint if exists communities_secondary_color_check;

alter table public.communities
  add constraint communities_secondary_color_check
  check (
...
-- New overloaded admin functions keep color writes transactional.
