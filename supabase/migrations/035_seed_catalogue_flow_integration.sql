...
-- Integration fixes for installations where migration 034 was already applied.
-- Keeps pending shared subjects discoverable to signed-in users, allows them to
-- plant the same pending subject instead of producing duplicates, and resolves
-- exact aliases/translations before creating a new catalogue item.
