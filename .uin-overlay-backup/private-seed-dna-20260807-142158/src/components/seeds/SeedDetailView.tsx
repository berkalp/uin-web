          ...
          <aside className="space-y-5">
            ...
            <section className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-7 text-gray-600">
                Saving keeps this Seed private for later. Watering is a social signal of support, not a request to join. Joining begins only when the Seed grows into an Intent.
              </p>
            </section>
          </aside>
        </div>
