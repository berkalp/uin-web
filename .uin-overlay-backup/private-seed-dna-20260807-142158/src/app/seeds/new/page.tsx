          ...
          <>
              ...
              <div className="grid lg:grid-cols-[minmax(0,1.3fr)_380px]">
                <div className="p-6 md:p-9">
                  ...
                  <p className="mt-4 max-w-3xl text-base leading-8 text-gray-600">
                    Books, films, games and other shared subjects begin in the Seed Library, so alternate spellings resolve to one subject. Personal goals remain personal and do not need to be forced into a catalogue.
                  </p>
                ...
                <div className="relative min-h-56 overflow-hidden bg-gradient-to-br from-emerald-950 via-green-800 to-lime-600 p-8 text-white">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-6 space-y-5">
                      ...
                      <div>
                        <p className="font-black">Personal Seed</p>
                        <p className="mt-1 text-sm leading-6 text-white/75">
                          A private habit, challenge, idea or goal that belongs only to you.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="mt-7 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              {seedTypes.map((seedType) => {
                ...
                const href = usesCatalogue
                  ...
                  : `/seeds/new?mode=personal&type=${encodeURIComponent(seedType.id)}`;
            ...
            <section className="mt-7 rounded-[28px] border border-dashed border-gray-300 bg-white p-6 text-center">
              ...
              <p className="mx-auto mt-2 max-w-2xl text-sm leading-6 text-gray-600">
                Create a personal Seed with your own title, notes, links and visibility. It will not be merged with anyone else’s goal.
              </p>
              <Link
