          ...
          <div className="grid lg:grid-cols-[minmax(0,1.25fr)_420px]">
            <div className="p-6 md:p-9">
              ...
              <p className="mt-4 max-w-3xl text-base leading-8 text-gray-600">
                Plant ideas, keep linked resources, record how they grow and preserve what remains after completion. A Seed may stay personal or grow into one or more social Intents.
              </p>
